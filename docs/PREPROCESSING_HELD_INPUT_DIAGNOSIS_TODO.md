...
| A43.6 | Full verification and release | in progress | Initial `a13d5ae` exact-SHA CI passed and live workdir7 became Ready with 721/724/727 skipped. Postflight exposed the old accepted-only `d61...` edge; its regression and final `20260911-recovery-input-skip-v2 make check-full` now pass. Remaining: second push/exact-SHA CI, install/restart and final live state/process/log proof. |
