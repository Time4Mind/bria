...
В «Настройки → Кнопки сессии» поле «Изображение Screen» циклически выбирает
...
`screen_capture_limit_kib`. После смены профиля прежний PNG и подтверждённый
Telegram file ID не переиспользуются.
