...
> Текущий запрос A30: дословно заменить базовый промпт препроцессора на текст
> Артёма. Договор и todo - [PREPROCESS_PROMPT_TODO.md](PREPROCESS_PROMPT_TODO.md).
> Пользовательские инструкции и настройки не менять. После тестов - стандартный
> автоматический push/CI/deploy существующего локального сервиса.
