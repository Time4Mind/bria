...
> A26+A27+A28 полностью проверены локально: раздельные лимиты, сохранение
> принятого запроса и общий таймер текста/скриншота с reset на действия владельца.
> Финальный make check-full PASS 2026-09-08 21:58 UTC, независимое review approve.
> Весь договор и todo - SPOILER_LIMITS_TODO.md. Выполняется согласованный выпуск:
> push точной версии, CI, установка/перезапуск и postflight. До receipt сервис старый.
