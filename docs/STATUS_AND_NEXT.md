...
> Текущий запрос A29: уход из сессии не должен перерисовывать меню/Ноды;
> следование последней странице и отдельная новая карточка с началом финала.
> Весь договор и todo - [NAVIGATION_FOLLOW_TODO.md](NAVIGATION_FOLLOW_TODO.md).
> Локально исправлены навигация, follow, exact final/new carrier, recovery enqueue
> и shutdown; независимое ревью и полный make check-full PASS23:46UTC 2026-09-08.
> Физическая сборка navigation-follow проверена, но ещё не установлена.
> Владелец исключил финалы сверх лимита из своей работы. Лимиты не меняем;
> ограничение документировано, а не исправлено. Блокер согласования снят.
> Свежий полный gate PASS04:46UTC 2026-09-09; ed0fdbc опубликован в origin/main,
> оба обязательных CI точного SHA успешны (34312399038, 34312399039).
> Артём повторно подтвердил автоматические push/merge/deploy и потребовал убрать
> конфликтующие правила. Пауза на повторное согласование отменена; AGENTS и его
> машинная защита опубликованы вместе в8e9a017. Его матрица CI прошла, Stage1
> выявил нестабильный test-only heartbeat negative control (34314357545).
> Контролируемая задержка воспроизвела ошибку фикстуры; синхронный sample oracle
> исправлен без runtime-изменений, race20 и новый полный gate PASS05:24UTC.
> Далее follow-up push/CI и deploy прежнего локального сервиса, без согласования.
> Пока установлен separate-spoiler-limits; четыре прежних unknown delivery не меняем.
