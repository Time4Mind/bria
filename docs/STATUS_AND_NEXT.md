...
> Дополнительные CI-прогоны выявили race тестового хранилища и ошибку порядка
> при мгновенном ответе. Обе исправлены; ungated1000 race-прогонов и свежий
> make check-full PASS. Выпуск 20260909-archive-resume-quiet ожидает нового CI;
> сервис пока не перезапускался. Промежуточные причины/статусы ниже исторические.
