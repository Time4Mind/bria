...
> Код и исправление CI-фикстуры запушены (fd3a47b); свежий полный gate PASS.
> Выпуск 20260909-archive-resume-quiet ожидает CI: на 11:51 UTC GitHub ещё
> не создал runs/check suites нового SHA. Сервис не перезапускался.
