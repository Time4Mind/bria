...
> Выполняется автоматический выпуск A29: свежий gate, push/CI, затем install/restart
> только прежнего локального сервиса. Пока он остаётся separate-spoiler-limits.
