// Package nativerender rasterizes bounded native ANSI terminal captures without
// accessing runtime state, settings, or transport.
...
var (
	ErrInvalidNativeOptions = errors.New("invalid native screen options")
