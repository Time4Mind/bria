...
// SessionStartMode and StartSessionRequest retain the public application API.
type SessionStartMode = providerattachport.SessionStartMode
type StartSessionRequest = providerattachport.StartSessionRequest

const (
	SessionStartNew    = providerattachport.SessionStartNew
	SessionStartResume = providerattachport.SessionStartResume
)
